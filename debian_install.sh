...
apt-get update
apt-get -y upgrade
apt-get -y install nano dnsutils unzip 
...
apt-get -force-yes --yes purge whiptail build-essential autoconf automake1.9 libtool flex bison debhelper binutils-gold
apt-get -force-yes --yes --purge autoremove
}
